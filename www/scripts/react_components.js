...
<div className="offcanvas offcanvas-top bg-black text-white" style={style} tabIndex="-1" id={id} aria-labelledby="offcanvasTopLabel">
  ...
  <div className="d-flex"> 
    ...
    <button className="btn btn-outline-warning btn-sm add btnBaseCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="getver">Обновить в базе</button>
...
<div className="d-grid col-1">
  <a className="btn btn-dark btn-sm add" href={link_index} target="_blank" role="button">Menu</a>
  <a className="btn btn-dark btn-sm add" href={link_sync} target="_blank" role="button">Sync</a>
  <a className="btn btn-dark btn-sm add" href={link_ptp} target="_blank" role="button">PTP</a>
  <a className="btn btn-dark btn-sm add" href={link_gnss} target="_blank" role="button">GNSS</a>
  ...
  <div className="d-grid col-2">
	<button className="btn btn-outline-primary btn-sm add btnCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="getgnss">GNSS</button> 
	<button className="btn btn-outline-primary btn-sm add btnCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="stgpsmon">Состояние приемника</button>
	<button className="btn btn-outline-primary btn-sm add btnCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="getver">Версия и параметры названия</button> 
	<button className="btn btn-outline-primary btn-sm add btnCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="getconfig">Настройки сети</button> 
	<button className="btn btn-outline-primary btn-sm add btnCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="getmac">МАС-адрес и серийный номер</button> 
	<button className="btn btn-outline-primary btn-sm add btnCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="getsync">Конфигурация синхронизации</button> 
	<button className="btn btn-outline-primary btn-sm add btnCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="getptp">Конфигурация PTP</button> 
	<button className="btn btn-outline-primary btn-sm add btnCurl" btnId={this.props.id} btnIP={this.props.ipaddr} btnCmd="getptpdata">Данные состояния PTP</button> 
    </div>
